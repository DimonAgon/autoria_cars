...
#chat messages
search_demand_url_request_chat_message = f"please enter search url alike\n ```https://auto.ria.com/<country_code>/search/<filters>```"
search_demand_submission_initiated_chat_message = "search demand submission is being processed"
search_demand_submission_success_chat_message = "search demand was submitted"
search_demand_submission_failure_chat_message = "your demand was not submitted"
autoria_search_url_authenticity_validation_success_chat_message = "autoria-search-url authenticity validation successful"
...
#logging
on_search_demand_url_request_logging_info_message = "search url requested from user {} of {}"
search_demand_submission_initiated_logging_info_message = "{} search demand submission initiated for user {} of {}"
search_demand_on_submission_success_logging_info_message = "{} search demand submission successful for user {} of {}"
search_demand_on_submission_failure_logging_error_message = "{} search demand submission failed for user {} of {}"
autoria_search_url_authenticity_validation_success_logging_info_message = "{} autoria-search-url authenticity validation successful"
